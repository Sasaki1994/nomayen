...
import { addDrink, editDrink, deleteDrink } from '../store/actions/people';
...
export default DrinkModal = ({
  ...
  const order = () => {
    dispatch(
      !!selectDrink ? editDrink(drink, people) : addDrink(drink, people)
    );
  ...
  const deleteOrder = () => {
    dispatch(deleteDrink(drink, people));
    setDrink(initialState);
    toggleVisible();
  };
  return (
